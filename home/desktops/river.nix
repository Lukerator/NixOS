		...
		settings = {
			...
			map = {
				normal = {
					...
					"Super 1" = "toggle-focused-tags 1";
					"Super 2" = "toggle-focused-tags 2";
					"Super 3" = "toggle-focused-tags 3";
					"Super 4" = "toggle-focused-tags 4";
					"Super 5" = "toggle-focused-tags 5";
					"Super 6" = "toggle-focused-tags 6";
					"Super 7" = "toggle-focused-tags 7";
					"Super 8" = "toggle-focused-tags 8";
					"Super 9" = "toggle-focused-tags 9";
					"Super 0" = "toggle-focused-tags 10";
